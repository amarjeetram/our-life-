...
export const metadata: Metadata = {
    ...
    keywords: 'fahrenheit to celsius, fahrenheit to celsius, temperature converter, fahrenheit to celsius',
    alternates: { canonical: 'https://smarttoolswala.com/unit-converters/temperature/fahrenheit-to-celsius' },
};
    ...
    const jsonLd = {
        ...
        "@graph": [
            ...
            { "@type": "BreadcrumbList", "itemListElement": [
                ...
                { "@type": "ListItem", "position": 4, "name": "Fahrenheit to Celsius", "item": "https://smarttoolswala.com/unit-converters/temperature/fahrenheit-to-celsius" }
            ]}
        ]
    };
    return (
