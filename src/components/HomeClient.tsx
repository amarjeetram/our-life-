        ...
        <div style={{ minHeight: "100vh", background: "#fafbff", overflow: "hidden" }}>
            ...
            <section id="tools" style={{ padding: "80px 20px", background: "#fafbff" }}>
                <div style={{ maxWidth: "820px", margin: "0 auto" }}>
                    ...
                    {/* PDF Tools Section */}
                    <div style={{ textAlign: "center", marginBottom: "40px" }}>
                        <span style={{ display: "block", fontSize: "12px", fontWeight: 800, letterSpacing: "0.1em", textTransform: "uppercase", color: "#f97316", marginBottom: "12px" }}>
                            Document Suite
                        </span>
                        <h2 style={{ fontSize: "clamp(26px, 4vw, 40px)", fontWeight: 900, color: "#0f172a", letterSpacing: "-0.03em", lineHeight: 1.15 }}>
                            PDF Tools
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(100%, 340px), 1fr))", gap: "24px" }}>
                        {[
                            {
                                route: '/compress-pdf-to-300kb', title: 'Compress PDF to 300KB',
                                desc: 'Perfect for UPSC, EPFO, and other state govt portals. Shrink your PDF documents to 300KB without losing readable quality.',
                                tags: ['PDF', 'Govt Docs', 'Exams']
                            }
                        ].map((tool, index) => (
                            <motion.div
                                key={tool.route}
                            ...
                            >
                                <Link href={tool.route} style={{
                                    ...
                                    background: "#ffffff", borderRadius: "24px",
                                    border: "1px solid #f1f5f9",
                                    boxShadow: "0 4px 24px rgba(249,115,22,0.06), 0 1px 3px rgba(0,0,0,0.02)",
                                    overflow: "hidden", textDecoration: "none",
                                    transition: "transform 0.2s, box-shadow 0.2s",
                                }}
                                    onMouseEnter={e => {
                                        (e.currentTarget as HTMLElement).style.transform = "translateY(-4px)";
                                        (e.currentTarget as HTMLElement).style.boxShadow = "0 16px 48px rgba(249,115,22,0.12), 0 2px 8px rgba(0,0,0,0.04)";
                                    }}
                                    onMouseLeave={e => {
                                        (e.currentTarget as HTMLElement).style.transform = "translateY(0)";
                                        (e.currentTarget as HTMLElement).style.boxShadow = "0 4px 24px rgba(249,115,22,0.06), 0 1px 3px rgba(0,0,0,0.02)";
                                    }}
                                >
                                    {/* Orange/Red top bar */}
                                    <div style={{ height: "4px", background: "linear-gradient(90deg, #f97316, #ef4444)" }} />
