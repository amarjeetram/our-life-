...
export const metadata: Metadata = {
    ...
    keywords: 'inches to feet, convert inches to feet, length converter, unit converter',
    alternates: {
        ...
        "@graph": [
            {
                ...
                "operatingSystem": "All",
                "description": "Convert Inches to Feet instantly with our free online calculator.",
