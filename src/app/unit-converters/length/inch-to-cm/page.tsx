        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 4, "name": "Inches to Centimeters", "item": "https://smarttoolswala.com/unit-converters/length/inch-to-cm" }
                ]
            }
        ]
    };
            ...
            <main className="py-12 md:py-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
                <div className="text-center mb-12">
                    ...
                    <p className="text-lg text-slate-600 font-medium max-w-2xl mx-auto">
                        Free, instant and accurate inches to centimeters conversion with a quick reference table.
                    </p>
                </div>
