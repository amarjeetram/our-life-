...
export const metadata: Metadata = {
    title: 'Feet to Inches Converter - Free Length Calculator',
    description: 'Convert Feet to Inches instantly with our free online calculator. Get accurate ft to in conversions, formulas, and reference tables.',
        ...
        "@graph": [
            {
                ...
                "operatingSystem": "All",
                "description": "Convert Feet to Inches instantly with our free online calculator. Accurate conversions for everyday use.",
