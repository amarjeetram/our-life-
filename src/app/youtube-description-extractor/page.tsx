...
export const metadata: Metadata = {
    ...
    description: 'Copy YouTube description, title, tags & views instantly with our free YouTube Description Extractor. Perfect for SEO research and competitor analysis.',
