...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: 'https://smarttoolswala.com/calculators/love-percentage-calculator-by-name',
    },
    openGraph: {
        title: 'Love Percentage Calculator by Name – Free Love Match Checker',
        description: 'Use our free Love Percentage Calculator by Name to check your love match instantly. Enter two names and find your love percentage online in seconds.',
        url: 'https://smarttoolswala.com/calculators/love-percentage-calculator-by-name',
        type: 'website',
    },
};
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        "itemListElement": [
                            ...
                            { "@type": "ListItem", "position": 3, "name": "Love Percentage Calculator by Name", "item": "https://smarttoolswala.com/calculators/love-percentage-calculator-by-name" }
                        ]
                    })
                }}
            />
                ...
                <article className="mt-16 bg-white p-8 md:p-12 rounded-[2rem] shadow-sm border border-slate-200 text-slate-700">
                    ...
                    <div className="space-y-6">
                        ...
                        <div>
                            ...
                            <p className="leading-relaxed">Absolutely! You can check the compatibility between any two names. Later, be sure to keep an eye out for our specialized Friendship Percentage Calculator!</p>
                        </div>
                    </div>
                </article>
