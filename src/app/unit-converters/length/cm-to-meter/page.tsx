...
export const metadata: Metadata = {
    title: { absolute: 'Centimeters to Meters Converter � Free Online Length Calculator' },
    description: 'Convert Centimeters to Meters instantly with our free online length converter. Accurate metric and imperial unit conversions for everyday use.',
        ...
        <div className="min-h-screen bg-green-50/40 font-sans">
            ...
            <main className="py-12 md:py-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
                ...
                <article className="mt-16 bg-white p-8 md:p-12 rounded-[2rem] border border-slate-200 text-slate-700">
                    <h2 className="text-3xl font-black text-slate-900 mb-6 tracking-tight">How to Convert Centimeters to Meters</h2>
                    <p className="mb-6 leading-relaxed text-lg">
                        Converting <strong>Centimeters to Meters</strong> is one of the most common length conversions needed in daily life, whether for construction, travel, or school assignments. Our free online converter handles this calculation instantly � no formulas needed.
                    </p>
                    <p className="mb-8 leading-relaxed text-lg">
                        Simply type your value in the input above and the result appears automatically. You can also use the swap button to reverse the conversion from Meters back to Centimeters.
                    </p>
                    <h3 className="text-xl font-bold text-slate-800 mb-4">Popular Centimeters to Meters Values</h3>
                    <div className="overflow-x-auto">
                        <table className="w-full text-left border-collapse text-sm">
                            <thead><tr className="bg-slate-50"><th className="p-3 font-bold border border-slate-200">Centimeters</th><th className="p-3 font-bold border border-slate-200">Meters</th></tr></thead>
                            <tbody>
